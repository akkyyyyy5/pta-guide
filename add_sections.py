NEW_SECTIONS = '''
    ...
    <div class="step-body">
      ...
      <div class="mockup-wrap">
        <div class="browser-bar">
          ...
          <div class="address-bar">🔒 lineworks.naver.jp — LINE WORKS</div>
        </div>
          ...
          <div style="display:flex;min-height:320px;font-family:'Noto Sans JP',sans-serif;">
            ...
            <div style="width:220px;background:#f7f7f7;border-right:1px solid #e0e0e0;">
              ...
              <div style="padding:10px 14px;display:flex;gap:10px;align-items:center;">
                <div style="width:36px;height:36px;background:#e3f2fd;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#1a73e8;font-size:14px;font-weight:700;flex-shrink:0;">星</div>
                <div>
              ...
              <div style="flex:1;padding:14px 16px;display:flex;flex-direction:column;gap:12px;overflow:hidden;">
                ...
                <div style="display:flex;gap:8px;">
                  ...
                  <div>
                    ...
                    <div style="background:#f1f3f4;border-radius:0 12px 12px 12px;padding:8px 12px;font-size:13px;max-width:220px;">確認しました！望遠鏡は3台確保できそうです 🔭</div>
                  </div>
                </div>
    ...
    <div class="step-body">
      ...
      <div class="mockup-wrap">
        ...
        <div class="browser-content">
          ...
          <!-- シートタブ -->
          <div style="background:#f8f9fc;border-bottom:1px solid #e0e0e0;padding:0 16px;display:flex;gap:0;">
            <div style="padding:8px 16px;font-size:12px;background:white;border:1px solid #e0e0e0;border-bottom:none;border-radius:4px 4px 0 0;color:#43a047;font-weight:700;">👥 役員名簿</div>
            <div style="padding:8px 16px;font-size:12px;color:#5f6368;">💰 会計</div>
            <div style="padding:8px 16px;font-size:12px;color:#5f6368;">🌟 星空観察イベント進捗</div>
            <div style="padding:8px 16px;font-size:12px;color:#5f6368;">📊 フォーム回答</div>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;">
              <thead>
                <tr style="background:#e8f5e9;">
                  <th style="padding:8px 12px;border:1px solid #c8e6c9;text-align:center;color:#5f6368;width:40px;">行</th>
                  <th style="padding:8px 12px;border:1px solid #c8e6c9;text-align:left;background:#43a047;color:white;">お名前</th>
                  ...
                  <th style="padding:8px 12px;border:1px solid #c8e6c9;text-align:left;background:#43a047;color:white;">連絡先</th>
                  <th style="padding:8px 12px;border:1px solid #c8e6c9;text-align:left;background:#43a047;color:white;">備考</th>
                </tr>
              </thead>
              <tbody>
                <tr style="background:#f1f8e9;">
                  <td style="padding:6px 12px;border:1px solid #dcedc8;text-align:center;color:#9e9e9e;">1</td>
                ...
                <tr>
                  <td style="padding:6px 12px;border:1px solid #dcedc8;text-align:center;color:#9e9e9e;">2</td>
                ...
                <tr style="background:#f1f8e9;">
                  <td style="padding:6px 12px;border:1px solid #dcedc8;text-align:center;color:#9e9e9e;">3</td>
                ...
                <tr>
                  <td style="padding:6px 12px;border:1px solid #dcedc8;text-align:center;color:#9e9e9e;">4</td>
  ...
  <section class="step-section" id="step-meet">
    ...
    <div class="step-body">
      <div class="instruction-text">
        Google Meetは、Googleが提供する無料のビデオ会議ツールです。<strong>Gmailアカウントがあれば今すぐ使えます</strong>。役員会・打ち合わせを完全オンラインにするだけで、「子どものお迎えがある」「仕事が終わらない」といった参加ハードルが一気に下がります。星空観察イベントの事前打ち合わせなど、ちょっとした確認にも最適です。
      </div>
            ...
            <div style="flex:1;display:grid;grid-template-columns:1fr 1fr;gap:4px;padding:8px;background:#202124;">
              <div style="background:#3c4043;border-radius:8px;padding:16px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;min-height:100px;">
                ...
                <div style="display:flex;gap:6px;">
                  <span style="background:rgba(255,255,255,0.1);border-radius:4px;padding:2px 6px;font-size:10px;color:rgba(255,255,255,0.7);">🎙️</span>
                </div>
              </div>
              <div style="background:#3c4043;border-radius:8px;padding:16px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;min-height:100px;">
                ...
                <div style="display:flex;gap:6px;">
                  <span style="background:rgba(255,87,34,0.3);border-radius:4px;padding:2px 6px;font-size:10px;color:#ff7043;">🔇 ミュート中</span>
                </div>
              </div>
              <div style="background:#3c4043;border-radius:8px;padding:16px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;min-height:100px;">
      ...
      <div class="annotation">
        ...
        <div class="annotation-text"><a href="https://meet.google.com" target="_blank" style="color:#1a73e8;"><strong>meet.google.com</strong></a> にアクセスして「新しい会議を作成」をクリックするだけ。リンクをコピーしてLINEやメールで送れば、相手はクリックするだけで参加できます。</div>
      </div>
      <div class="annotation">
        <div class="annotation-circle" style="background:#039be5;">2</div>
        <div class="annotation-text"><strong>画面共有</strong>: 「📋」ボタンから自分の画面を共有できます。スプレッドシートやドキュメントを見ながら会議を進められます。</div>
      </div>
      <div class="annotation">
        <div class="annotation-circle" style="background:#039be5;">3</div>
        <div class="annotation-text"><strong>Googleカレンダーと連携</strong>: Googleカレンダーで会議の予定を作ると、MeetのリンクがURL付きで自動生成されます。招待状を役員全員に送ればリマインドも兼ねられます。</div>
      </div>
      ...
      <div class="point-box">
        ...
        <table style="width:100%;border-collapse:collapse;margin-top:8px;font-size:13px;">
          ...
          <tr><td style="padding:6px 8px;border:1px solid #e0e0e0;">新役員への引き継ぎ</td><td style="padding:6px 8px;border:1px solid #e0e0e0;">画面録画機能で説明動画を作成・保存</td></tr>
        </table>
      </div>
      <div class="point-box">
...
# 完了バナーの直前に新セクションを挿入
content = content.replace(FINISH_BANNER, NEW_SECTIONS + FINISH_BANNER)

# ナビバーにリンク追加
old_nav = '<a href="#step-drive">📁 ドライブ</a>'
new_nav = '<a href="#step-drive">📁 ドライブ</a>\n    <a href="#step-lineworks">💬 LINE WORKS</a>\n    <a href="#step-sheets">📊 スプレッドシート</a>\n    <a href="#step-meet">📹 Meet</a>'
...
print('Done! 3 new sections added.')
