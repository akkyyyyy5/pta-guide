        ...
        <div class="browser-content">
          <div style="display:flex;min-height:320px;">
            ...
            <div style="flex:1;display:flex;flex-direction:column;background:white;">
              <div style="padding:10px 16px;border-bottom:1px solid #e0e0e0;font-size:13px;font-weight:700;color:#202124;">&#x1F4CC; 2025年度 ミーティング <span style="font-size:11px;color:#9e9e9e;font-weight:400;">8名</span></div>
